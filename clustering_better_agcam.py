    ...
    with open('results.csv', 'w', newline='') as csvfile:
        ...
        for data in tqdm(validloader):
            ...
            if (args.method == 'better_agcam'):
                ...
                tensor_heatmaps = tensor_heatmaps.reshape(144, 1, 14, 14).cuda()
                ...
                similarity = get_cos_similar_matrix(tensor_heatmaps,tensor_heatmaps)
                ...
                for i in range(len(tensor_heatmaps)):
                    mask_clustering[cluster_labels[i]]+=tensor_heatmaps[i]
                ...
                print('Sau khi cluster xong, shape: ', mask_clustering_norm.shape)

                tensor_heatmaps = transforms.Resize((224, 224))(mask_clustering_norm)
