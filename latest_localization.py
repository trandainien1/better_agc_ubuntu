...
if METHOD == 'scoreagc':
    ...
    model = timm.create_model(model_name="vit_base_patch16_224", pretrained=True, pretrained_cfg='orig_in21k_ft_in1k', num_classes=200)
...
with torch.enable_grad():      
    ...
    for idx, data in enumerate(tqdm(validloader)):
        ...
        print('[DEBUG]: ', prediction, label.item())
